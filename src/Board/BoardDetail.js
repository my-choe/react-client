...
export default class BoardDetail extends Component {
    ...
    getDetail = () => {
        ...
        axios.post("http://localhost:5000/board/detail", send_param)
        .then(returnData => {
                ...
                const board = (
                    <div>
                        ...
                        <div>
                            ...
                            <Button block onClick={this.deleteBoard.bind(
    ...
    deleteBoard = _id => {
        ...
        if(window.confirm("해당 게시글을 삭제하시겠습니까?")){
            axios.post("http://localhost:5000/board/delete", send_param)
            .then(returnData => {
                alert("게시글이 삭제되었습니다.");
                window.location.href="/";
            })
